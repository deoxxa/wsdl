...
var WSDL = module.exports = function WSDL(options) {
    ...
    if (options.messageHandlers) {
        this.messageHandlers =
            this.messageHandlers.concat(options.messageHandlers);
    }
 
    if (options.partHandlers) {
        this.partHandlers =
            this.partHandlers.concat(options.partHandlers);
    }
 
    if (options.portTypeHandlers) {
        this.portTypeHandlers =
            this.portTypeHandlers.concat(options.portTypeHandlers);
    }
 
    if (options.bindingHandlers) {
        this.bindingHandlers =
            this.bindingHandlers.concat(options.bindingHandlers);
    }
 
    if (options.operationHandlers) {
        this.operationHandlers =
            this.operationHandlers.concat(options.operationHandlers);
    }

    if (options.serviceHandlers) {
        this.serviceHandlers =
            this.serviceHandlers.concat(options.serviceHandlers);
    }
...
WSDL.prototype.addPortTypeHandler = function addPortTypeHandler(
    portTypeHandler
) {
...
WSDL.prototype.addOperationHandler = function addOperationHandler(
    operationHandler
) {
    this.operationHandlers.push(operationHandler);
};

WSDL.prototype.addServiceHandler = function addServiceHandler(
    serviceHandler
) {
...
WSDL.prototype.operationFromXML = function operationFromXML(element) {
    ...
    var input = element.getElementsByTagNameNS(
        "http://schemas.xmlsoap.org/wsdl/",
        "input"
    );
    ...
    var output = element.getElementsByTagNameNS(
        "http://schemas.xmlsoap.org/wsdl/",
        "output"
    );
    ...
    var fault = element.getElementsByTagNameNS(
        "http://schemas.xmlsoap.org/wsdl/",
        "fault"
    );
